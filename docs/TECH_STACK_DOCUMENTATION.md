...
หน้า Home ซึ่งนิยามในไฟล์ `app/(tabs)/index.tsx` ทำหน้าที่เป็นจุดเริ่มต้นหลักของการใช้งาน PinnitApp โดยแสดงรายการปักหมุด (pins) ทั้งหมดที่ผู้ใช้สามารถมองเห็นได้ในขณะนั้น ซึ่งอาจมาจากสองแหล่งคือ รายการที่เก็บในเครื่อง (local storage) และรายการที่เก็บในฐานข้อมูล Supabase (กรณีผู้ใช้ล็อกอิน) เมื่อผู้ใช้กดปุ่ม `+` ที่มุมหน้าจอ ระบบจะอ่านตำแหน่ง GPS ปัจจุบันของผู้ใช้ เรียกใช้บริการ reverse geocoding เพื่อหาชื่อสถานที่ และสร้างรายการปักหมุดใหม่เพิ่มเข้าไปในรายการ
